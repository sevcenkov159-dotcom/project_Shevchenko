...
class ApplicationForm(tk.Tk):
    ...
    def create_widgets(self):
        ...
        info_frame = tk.Frame(
            self, bg=self.bg_light_gray, bd=2, relief=tk.SOLID  # Увеличен bd с 1 до 2
        )
        ...
        main_frame.columnconfigure(0, weight=0)  # Для меток
        main_frame.columnconfigure(1, weight=1)  # Для полей ввода
        main_frame.columnconfigure(2, weight=0)  # Для кнопок

        # --- Строка 0: Ваше имя ---
        self.create_row_label(main_frame, "Ваше имя:", 0, required=True)
        self.entry_name = tk.Entry(main_frame, bd=2, relief=tk.SOLID)  # Увеличен bd с 1 до 2
        ...
        self.entry_email = tk.Entry(main_frame, bd=2, relief=tk.SOLID)  # Увеличен bd с 1 до 2
        self.entry_email.grid(
            row=1, column=1, columnspan=2, sticky="ew", padx=5, pady=3, ipady=3
        )

        # --- Строка 2: Тема письма ---
        self.create_row_label(main_frame, "Тема письма:", 2, required=False)
        self.entry_subject = tk.Entry(main_frame, bd=2, relief=tk.SOLID)  # Увеличен bd с 1 до 2
        ...
        for i in range(3):
            row_idx = 3 + i
            self.create_row_label(main_frame, "Прикрепить файл:", row_idx, required=False)

            # Поле вывода пути к файлу
            file_entry = tk.Entry(
                main_frame, bd=2, relief=tk.SOLID, state="readonly"  # Увеличен bd с 1 до 2
            )
            file_entry.grid(
            ...
            btn_browse = tk.Button(
                main_frame,
                text="Обзор...",
                font=("Arial", 10),  # Увеличен шрифт с 9 до 10
                bg="#e1e1e1",
                relief=tk.RAISED,
                bd=2,  # Добавлена рамка для кнопки
                padx=15,  # Добавлены внутренние отступы
                pady=2,   # Добавлены внутренние отступы
        ...
        self.text_message = tk.Text(main_frame, bd=2, relief=tk.SOLID, height=8)  # Увеличен bd с 1 до 2
        ...
        # Увеличенная кнопка "Отправить Email"
        btn_send = tk.Button(
            bottom_frame,
            text="Отправить Email",
            font=("Arial", 11, "bold"),  # Увеличен шрифт и сделан жирным
            bg="#e1e1e1",
            fg="#0066cc",  # Синий цвет текста для акцента
            bd=3,  # Жирная рамка
            relief=tk.RAISED,
            padx=35,  # Увеличен горизонтальный отступ
            pady=8,   # Увеличен вертикальный отступ
            cursor="hand2",  # Курсор в виде руки при наведении
            command=self.send_email,
        )
        btn_send.pack(side=tk.LEFT, padx=(150, 10))  # Скорректирован отступ слева

        # Увеличенная кнопка "Очистить"
        btn_clear = tk.Button(
            bottom_frame,
            text="Очистить",
            font=("Arial", 11, "bold"),  # Увеличен шрифт и сделан жирным
            bg="#e1e1e1",
            fg="#cc0000",  # Красный цвет текста для акцента
            bd=3,  # Жирная рамка
            relief=tk.RAISED,
            padx=25,  # Увеличен горизонтальный отступ
            pady=8,   # Увеличен вертикальный отступ
            cursor="hand2",  # Курсор в виде руки при наведении
